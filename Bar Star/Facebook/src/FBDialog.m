...
- (void)addObservers {
    NSLog(@"The fbdialog view is opened #######addObservers");
...
- (void)removeObservers {
    NSLog(@"The fbdialog view is opened #######removeObservers");
...
- (void)postDismissCleanup {
    NSLog(@"The fbdialog view is opened #######postDismissCleanup");
...
- (void)dismiss:(BOOL)animated {
    NSLog(@"The fbdialog view is opened #######dismiss");
...
- (void)dialogDidSucceed:(NSURL *)url {
    ...
    NSLog(@"The fbdialog view is opened #######dialogDidSucceed");
...
- (void)dialogDidCancel:(NSURL *)url {
    ...
    NSLog(@"The fbdialog view is opened #######dialogDidCancel");
